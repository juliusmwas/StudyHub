...
const steps = [
  {
    ...
    icon: FaRegCheckCircle, // Pass the component itself, not JSX
  },
  {
    step: '02',
...
export default function HowItWorksSection() { // Changed to a named function component
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 items-center">
          ...
          <div className="w-full lg:w-1/3 mb-10 lg:mb-0">
            <div className="rounded-2xl shadow-xl overflow-hidden transform transition duration-500 hover:scale-[1.02]">
              {/* This div simulates the image from the provided design */}
              {/* Replace with an actual <img /> tag pointing to your asset */}
              <div className="bg-cover bg-center h-96 min-h-60"
                   style={{
                     backgroundImage: `url('https://images.unsplash.com/photo-1517404215738-ee2536862a49?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')`, // Using a sample image for visualization
